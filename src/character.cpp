...
Character::Character() {
    ...
    current_y_tile = 1;
    tile_length = 64;
    current_image = cinder::ciAnimatedGif::create( ci::app::loadAsset("beemo/beemo right.gif"));
    orientation = "right";
    ap = 20;
    total_hp = 100;
    current_hp = 100;
...
Character::Character(size_t start_x_tile, size_t start_y_tile, size_t tile_size, const string& image_file_name) {
...
void Character::SetImage(const string& new_orientation) {
    orientation = new_orientation;
    current_image = cinder::ciAnimatedGif::create( ci::app::loadAsset("beemo/beemo "+ orientation + ".gif"));
}
...
void Character::Uncover() {
    current_image = cinder::ciAnimatedGif::create( ci::app::loadAsset("beemo_uncover/beemo uncover "+ orientation +".gif"));
}

void Character::Grab(mylibrary::Item item_to_grab) {
    current_image = cinder::ciAnimatedGif::create( ci::app::loadAsset("beemo_grab/beemo grab "+ orientation +".gif"));
